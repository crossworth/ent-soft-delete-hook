...
func (tu *TodoUpdate) SetDeletedTime(t time.Time) *TodoUpdate {
	tu.mutation.SetDeletedTime(t)
	return tu
}

// SetNillableDeletedTime sets the "deleted_time" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableDeletedTime(t *time.Time) *TodoUpdate {
	if t != nil {
		tu.SetDeletedTime(*t)
	}
	return tu
...
func (tu *TodoUpdate) ClearDeletedTime() *TodoUpdate {
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.DeletedTimeCleared() {
		_spec.ClearField(todo.FieldDeletedTime, field.TypeTime)
	}
...
// SetDeletedTime sets the "deleted_time" field.
func (tuo *TodoUpdateOne) SetDeletedTime(t time.Time) *TodoUpdateOne {
	tuo.mutation.SetDeletedTime(t)
	return tuo
}

// SetNillableDeletedTime sets the "deleted_time" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableDeletedTime(t *time.Time) *TodoUpdateOne {
	if t != nil {
...
// ClearDeletedTime clears the value of the "deleted_time" field.
func (tuo *TodoUpdateOne) ClearDeletedTime() *TodoUpdateOne {
