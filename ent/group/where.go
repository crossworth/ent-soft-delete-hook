...
func DeletedTime(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeEQ(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDeletedTime), v))
	})
}
...
func DeletedTimeNEQ(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeIn(vs ...time.Time) predicate.Group {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedTimeNotIn(vs ...time.Time) predicate.Group {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedTimeGT(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeGTE(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeLT(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeLTE(v time.Time) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeIsNil() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func DeletedTimeNotNil() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
