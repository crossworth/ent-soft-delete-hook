...
func (tq *TodoQuery) QueryCreator() *UserQuery {
...
func (tq *TodoQuery) WithCreator(opts ...func(*UserQuery)) *TodoQuery {
	query := &UserQuery{config: tq.config}
...
func (tq *TodoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Todo, error) {
	...
	if query := tq.withCreator; query != nil {
		if err := tq.loadCreator(ctx, query, nodes, nil,
			func(n *Todo, e *User) { n.Edges.Creator = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TodoQuery) loadCreator(ctx context.Context, query *UserQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *User)) error {
...
func (tgb *TodoGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TodoGroupBy](ctx, tgb, tgb.build.inters, v)
}

func (tgb *TodoGroupBy) sqlScan(ctx context.Context, v any) error {
	selector := tgb.sqlQuery(ctx)
	if err := selector.Err(); err != nil {
		return err
	}
	rows := &sql.Rows{}
...
func (tgb *TodoGroupBy) sqlQuery(ctx context.Context) *sql.Selector {
	selector := tgb.build.sqlQuery(ctx).Select()
	...
	return selector.GroupBy(selector.Columns(*tgb.flds...)...)
}
...
func (ts *TodoSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TodoSelect](ctx, ts, ts.inters, v)
}

func (ts *TodoSelect) sqlScan(ctx context.Context, v any) error {
	selector := ts.TodoQuery.sqlQuery(ctx)
